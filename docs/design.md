...
| ОС ВМ | Ubuntu 22.04/24.04 (точная версия, RAM, CPU, диск — уточнить) |
...
Требования: Ubuntu 24.04 (или 22.04), ≥ 64 ГБ RAM (загрузка 28 ГБ весов идёт через
RAM), ≥ 8 vCPU, ≥ 300 ГБ SSD (образы ~20 ГБ, модели 30–60 ГБ, логи, запас на вторую
модель), время по NTP.
